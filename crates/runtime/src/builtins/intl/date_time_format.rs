...
pub fn dispatch_call(
    ...
    if resolved.is(DATE_TIME_FORMAT) {
        return Some(construct_inner(agent, callee, this, true, args));
    }
    if resolved.is(DTF_SUPPORTED_LOCALES_OF) {
