...
Test262Error = function (message) {
  var err = Object.create(Test262Error.prototype);
...
"#;
    ...
    /// The async test protocol (test262 async harness): fixtures with
    /// `flags: [async]` signal completion via `$DONE()` (success) or
    /// `$DONE(error)` (failure). The runner drains the job queue, then reads
    /// the two globals below — `asyncTestPassed` guards against double calls
    /// (the canonical harness flag), `asyncTestError` carries the failure
    /// value (a non-undefined/null `$DONE` argument).
    const ASYNC_PRELUDE: &str = r#"
var asyncTestPassed = false;
var asyncTestError;
var $DONE = function (error) {
  if (asyncTestPassed) return;
  asyncTestPassed = true;
...
"#;
    ...
    // Phase 15 — control abstraction (Iterator, async iterators, generators,
    // async functions, promises, explicit resource management).
    test262_builtin_fixture!(
        Iterator_concat_fresh_iterator_result,
        "Iterator/concat/fresh-iterator-result.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_get_iterator_method_throws,
        "Iterator/concat/get-iterator-method-throws.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_get_value_after_done,
        "Iterator/concat/get-value-after-done.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_is_function,
        "Iterator/concat/is-function.js"
    );
    test262_builtin_fixture!(Iterator_concat_length, "Iterator/concat/length.js");
    test262_builtin_fixture!(
        Iterator_concat_many_arguments,
        "Iterator/concat/many-arguments.js"
    );
    test262_builtin_fixture!(Iterator_concat_name, "Iterator/concat/name.js");
    test262_builtin_fixture!(
        Iterator_concat_next_method_called_with_zero_arguments,
        "Iterator/concat/next-method-called-with-zero-arguments.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_next_method_returns_non_object,
        "Iterator/concat/next-method-returns-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_next_method_returns_throwing_done,
        "Iterator/concat/next-method-returns-throwing-done.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_next_method_returns_throwing_value,
        "Iterator/concat/next-method-returns-throwing-value.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_next_method_throws,
        "Iterator/concat/next-method-throws.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_non_constructible,
        "Iterator/concat/non-constructible.js"
    );
    test262_builtin_fixture!(Iterator_concat_prop_desc, "Iterator/concat/prop-desc.js");
    test262_builtin_fixture!(Iterator_concat_proto, "Iterator/concat/proto.js");
    test262_builtin_fixture!(
        Iterator_concat_result_is_iterator,
        "Iterator/concat/result-is-iterator.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_return_is_forwarded,
        "Iterator/concat/return-is-forwarded.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_return_method_called_with_zero_arguments,
        "Iterator/concat/return-method-called-with-zero-arguments.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_single_argument,
        "Iterator/concat/single-argument.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_throws_typeerror_when_generator_is_running_next,
        "Iterator/concat/throws-typeerror-when-generator-is-running-next.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_throws_typeerror_when_generator_is_running_return,
        "Iterator/concat/throws-typeerror-when-generator-is-running-return.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_throws_typeerror_when_iterator_method_not_callable,
        "Iterator/concat/throws-typeerror-when-iterator-method-not-callable.js"
    );
    test262_builtin_fixture!(
        Iterator_concat_zero_arguments,
        "Iterator/concat/zero-arguments.js"
    );
    test262_builtin_fixture!(Iterator_constructor, "Iterator/constructor.js");
    test262_builtin_fixture!(Iterator_from_callable, "Iterator/from/callable.js");
    test262_builtin_fixture!(
        Iterator_from_get_next_method_only_once,
        "Iterator/from/get-next-method-only-once.js"
    );
    test262_builtin_fixture!(
        Iterator_from_get_next_method_throws,
        "Iterator/from/get-next-method-throws.js"
    );
    test262_builtin_fixture!(Iterator_from_is_function, "Iterator/from/is-function.js");
    test262_builtin_fixture!(
        Iterator_from_iterable_to_iterator_fallback,
        "Iterator/from/iterable-to-iterator-fallback.js"
    );
    test262_builtin_fixture!(Iterator_from_length, "Iterator/from/length.js");
    test262_builtin_fixture!(Iterator_from_name, "Iterator/from/name.js");
    test262_builtin_fixture!(
        Iterator_from_non_constructible,
        "Iterator/from/non-constructible.js"
    );
    test262_builtin_fixture!(Iterator_from_primitives, "Iterator/from/primitives.js");
    test262_builtin_fixture!(Iterator_from_prop_desc, "Iterator/from/prop-desc.js");
    test262_builtin_fixture!(Iterator_from_proto, "Iterator/from/proto.js");
    test262_builtin_fixture!(Iterator_from_result_proto, "Iterator/from/result-proto.js");
    test262_builtin_fixture!(
        Iterator_from_supports_iterator,
        "Iterator/from/supports-iterator.js"
    );
    test262_builtin_fixture!(Iterator_length, "Iterator/length.js");
    test262_builtin_fixture!(Iterator_name, "Iterator/name.js");
    test262_builtin_fixture!(
        Iterator_newtarget_or_active_function_object,
        "Iterator/newtarget-or-active-function-object.js"
    );
    test262_builtin_fixture!(Iterator_prop_desc, "Iterator/prop-desc.js");
    test262_builtin_fixture!(Iterator_proto, "Iterator/proto.js");
    test262_builtin_fixture!(
        Iterator_prototype_chunks_chunkSize_no_coercion,
        "Iterator/prototype/chunks/chunkSize-no-coercion.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_chunkSize_not_a_number,
        "Iterator/prototype/chunks/chunkSize-not-a-number.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_is_function,
        "Iterator/prototype/chunks/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_length,
        "Iterator/prototype/chunks/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_name,
        "Iterator/prototype/chunks/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_non_constructible,
        "Iterator/prototype/chunks/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_prop_desc,
        "Iterator/prototype/chunks/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_chunks_this_non_object,
        "Iterator/prototype/chunks/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_constructor_prop_desc,
        "Iterator/prototype/constructor/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_drop_is_function,
        "Iterator/prototype/drop/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_drop_length,
        "Iterator/prototype/drop/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_drop_name,
        "Iterator/prototype/drop/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_drop_non_constructible,
        "Iterator/prototype/drop/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_drop_prop_desc,
        "Iterator/prototype/drop/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_drop_this_non_object,
        "Iterator/prototype/drop/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_argument_effect_order,
        "Iterator/prototype/every/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_is_function,
        "Iterator/prototype/every/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_length,
        "Iterator/prototype/every/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_name,
        "Iterator/prototype/every/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_non_callable_predicate,
        "Iterator/prototype/every/non-callable-predicate.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_non_constructible,
        "Iterator/prototype/every/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_prop_desc,
        "Iterator/prototype/every/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_this_non_callable_next,
        "Iterator/prototype/every/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_every_this_non_object,
        "Iterator/prototype/every/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_argument_effect_order,
        "Iterator/prototype/filter/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_is_function,
        "Iterator/prototype/filter/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_length,
        "Iterator/prototype/filter/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_name,
        "Iterator/prototype/filter/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_non_callable_predicate,
        "Iterator/prototype/filter/non-callable-predicate.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_non_constructible,
        "Iterator/prototype/filter/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_prop_desc,
        "Iterator/prototype/filter/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_filter_this_non_object,
        "Iterator/prototype/filter/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_argument_effect_order,
        "Iterator/prototype/find/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_is_function,
        "Iterator/prototype/find/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_length,
        "Iterator/prototype/find/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_name,
        "Iterator/prototype/find/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_non_callable_predicate,
        "Iterator/prototype/find/non-callable-predicate.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_non_constructible,
        "Iterator/prototype/find/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_prop_desc,
        "Iterator/prototype/find/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_this_non_callable_next,
        "Iterator/prototype/find/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_find_this_non_object,
        "Iterator/prototype/find/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_argument_effect_order,
        "Iterator/prototype/flatMap/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_is_function,
        "Iterator/prototype/flatMap/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_length,
        "Iterator/prototype/flatMap/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_name,
        "Iterator/prototype/flatMap/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_non_callable_mapper,
        "Iterator/prototype/flatMap/non-callable-mapper.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_non_constructible,
        "Iterator/prototype/flatMap/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_prop_desc,
        "Iterator/prototype/flatMap/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_flatMap_this_non_object,
        "Iterator/prototype/flatMap/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_argument_effect_order,
        "Iterator/prototype/forEach/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_is_function,
        "Iterator/prototype/forEach/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_length,
        "Iterator/prototype/forEach/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_name,
        "Iterator/prototype/forEach/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_non_callable_predicate,
        "Iterator/prototype/forEach/non-callable-predicate.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_non_constructible,
        "Iterator/prototype/forEach/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_prop_desc,
        "Iterator/prototype/forEach/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_this_non_callable_next,
        "Iterator/prototype/forEach/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_forEach_this_non_object,
        "Iterator/prototype/forEach/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_basic_match_and_miss,
        "Iterator/prototype/includes/basic-match-and-miss.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_closes_on_match,
        "Iterator/prototype/includes/closes-on-match.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_exhaustion_does_not_call_return,
        "Iterator/prototype/includes/exhaustion-does-not-call-return.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_get_next_method_only_once,
        "Iterator/prototype/includes/get-next-method-only-once.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_get_next_method_throws,
        "Iterator/prototype/includes/get-next-method-throws.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_get_return_method_throws,
        "Iterator/prototype/includes/get-return-method-throws.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_is_function,
        "Iterator/prototype/includes/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_iterator_has_no_return,
        "Iterator/prototype/includes/iterator-has-no-return.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_iterator_return_method_throws,
        "Iterator/prototype/includes/iterator-return-method-throws.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_length,
        "Iterator/prototype/includes/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_name,
        "Iterator/prototype/includes/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_next_method_returns_non_object,
        "Iterator/prototype/includes/next-method-returns-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_next_method_returns_throwing_done,
        "Iterator/prototype/includes/next-method-returns-throwing-done.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_next_method_returns_throwing_value_done,
        "Iterator/prototype/includes/next-method-returns-throwing-value-done.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_next_method_returns_throwing_value,
        "Iterator/prototype/includes/next-method-returns-throwing-value.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_next_method_throws,
        "Iterator/prototype/includes/next-method-throws.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_non_constructible,
        "Iterator/prototype/includes/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_object_identity,
        "Iterator/prototype/includes/object-identity.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_prop_desc,
        "Iterator/prototype/includes/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_samevaluezero_nan,
        "Iterator/prototype/includes/samevaluezero-nan.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_samevaluezero_zeroes,
        "Iterator/prototype/includes/samevaluezero-zeroes.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_skipped_elements_default,
        "Iterator/prototype/includes/skipped-elements-default.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_skipped_elements_zero_and_negative_zero,
        "Iterator/prototype/includes/skipped-elements-zero-and-negative-zero.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_symbol_identity,
        "Iterator/prototype/includes/symbol-identity.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_this_non_callable_next,
        "Iterator/prototype/includes/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_includes_this_non_object,
        "Iterator/prototype/includes/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_initial_value,
        "Iterator/prototype/initial-value.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_contents_tostring,
        "Iterator/prototype/join/contents-tostring.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_descriptor,
        "Iterator/prototype/join/descriptor.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_does_not_close_on_iterator_protocol_violation,
        "Iterator/prototype/join/does-not-close-on-iterator-protocol-violation.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_length,
        "Iterator/prototype/join/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_name,
        "Iterator/prototype/join/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_not_a_constructor,
        "Iterator/prototype/join/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_receiver_not_object,
        "Iterator/prototype/join/receiver-not-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_results_empty_separator,
        "Iterator/prototype/join/results-empty-separator.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_results_no_separator,
        "Iterator/prototype/join/results-no-separator.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_results_nonempty_separator,
        "Iterator/prototype/join/results-nonempty-separator.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_join_separator_tostring,
        "Iterator/prototype/join/separator-tostring.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_argument_effect_order,
        "Iterator/prototype/map/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_is_function,
        "Iterator/prototype/map/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_length,
        "Iterator/prototype/map/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_name,
        "Iterator/prototype/map/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_non_callable_mapper,
        "Iterator/prototype/map/non-callable-mapper.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_non_constructible,
        "Iterator/prototype/map/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_prop_desc,
        "Iterator/prototype/map/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_map_this_non_object,
        "Iterator/prototype/map/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_is_function,
        "Iterator/prototype/reduce/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_length,
        "Iterator/prototype/reduce/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_name,
        "Iterator/prototype/reduce/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_non_constructible,
        "Iterator/prototype/reduce/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_prop_desc,
        "Iterator/prototype/reduce/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_this_non_callable_next,
        "Iterator/prototype/reduce/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_reduce_this_non_object,
        "Iterator/prototype/reduce/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_argument_effect_order,
        "Iterator/prototype/some/argument-effect-order.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_is_function,
        "Iterator/prototype/some/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_length,
        "Iterator/prototype/some/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_name,
        "Iterator/prototype/some/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_non_callable_predicate,
        "Iterator/prototype/some/non-callable-predicate.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_non_constructible,
        "Iterator/prototype/some/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_prop_desc,
        "Iterator/prototype/some/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_this_non_callable_next,
        "Iterator/prototype/some/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_some_this_non_object,
        "Iterator/prototype/some/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_dispose_is_function,
        "Iterator/prototype/Symbol.dispose/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_dispose_length,
        "Iterator/prototype/Symbol.dispose/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_dispose_name,
        "Iterator/prototype/Symbol.dispose/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_dispose_prop_desc,
        "Iterator/prototype/Symbol.dispose/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_iterator_is_function,
        "Iterator/prototype/Symbol.iterator/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_iterator_length,
        "Iterator/prototype/Symbol.iterator/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_iterator_name,
        "Iterator/prototype/Symbol.iterator/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_Symbol_iterator_prop_desc,
        "Iterator/prototype/Symbol.iterator/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_take_is_function,
        "Iterator/prototype/take/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_take_length,
        "Iterator/prototype/take/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_take_name,
        "Iterator/prototype/take/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_take_non_constructible,
        "Iterator/prototype/take/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_take_prop_desc,
        "Iterator/prototype/take/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_take_this_non_object,
        "Iterator/prototype/take/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_is_function,
        "Iterator/prototype/toArray/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_length,
        "Iterator/prototype/toArray/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_name,
        "Iterator/prototype/toArray/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_non_constructible,
        "Iterator/prototype/toArray/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_prop_desc,
        "Iterator/prototype/toArray/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_this_non_callable_next,
        "Iterator/prototype/toArray/this-non-callable-next.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_toArray_this_non_object,
        "Iterator/prototype/toArray/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_is_function,
        "Iterator/prototype/windows/is-function.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_length,
        "Iterator/prototype/windows/length.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_name,
        "Iterator/prototype/windows/name.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_non_constructible,
        "Iterator/prototype/windows/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_prop_desc,
        "Iterator/prototype/windows/prop-desc.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_this_non_object,
        "Iterator/prototype/windows/this-non-object.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_undersized_invalid,
        "Iterator/prototype/windows/undersized-invalid.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_windowSize_no_coercion,
        "Iterator/prototype/windows/windowSize-no-coercion.js"
    );
    test262_builtin_fixture!(
        Iterator_prototype_windows_windowSize_not_a_number,
        "Iterator/prototype/windows/windowSize-not-a-number.js"
    );
    test262_builtin_fixture!(Iterator_zip_is_function, "Iterator/zip/is-function.js");
    test262_builtin_fixture!(
        Iterator_zip_iterator_non_iterable,
        "Iterator/zip/iterator-non-iterable.js"
    );
    test262_builtin_fixture!(Iterator_zip_length, "Iterator/zip/length.js");
    test262_builtin_fixture!(Iterator_zip_name, "Iterator/zip/name.js");
    test262_builtin_fixture!(
        Iterator_zip_non_constructible,
        "Iterator/zip/non-constructible.js"
    );
    test262_builtin_fixture!(Iterator_zip_prop_desc, "Iterator/zip/prop-desc.js");
    test262_builtin_fixture!(Iterator_zip_proto, "Iterator/zip/proto.js");
    test262_builtin_fixture!(
        Iterator_zip_suspended_yield_iterator_close_calls_next,
        "Iterator/zip/suspended-yield-iterator-close-calls-next.js"
    );
    test262_builtin_fixture!(
        Iterator_zip_suspended_yield_iterator_close_calls_return,
        "Iterator/zip/suspended-yield-iterator-close-calls-return.js"
    );
    test262_builtin_fixture!(
        Iterator_zipKeyed_is_function,
        "Iterator/zipKeyed/is-function.js"
    );
    test262_builtin_fixture!(Iterator_zipKeyed_length, "Iterator/zipKeyed/length.js");
    test262_builtin_fixture!(Iterator_zipKeyed_name, "Iterator/zipKeyed/name.js");
    test262_builtin_fixture!(
        Iterator_zipKeyed_non_constructible,
        "Iterator/zipKeyed/non-constructible.js"
    );
    test262_builtin_fixture!(
        Iterator_zipKeyed_prop_desc,
        "Iterator/zipKeyed/prop-desc.js"
    );
    test262_builtin_fixture!(Iterator_zipKeyed_proto, "Iterator/zipKeyed/proto.js");
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncDispose_is_function,
        "AsyncIteratorPrototype/Symbol.asyncDispose/is-function.js"
    );
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncDispose_length,
        "AsyncIteratorPrototype/Symbol.asyncDispose/length.js"
    );
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncDispose_name,
        "AsyncIteratorPrototype/Symbol.asyncDispose/name.js"
    );
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncDispose_prop_desc,
        "AsyncIteratorPrototype/Symbol.asyncDispose/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncIterator_length,
        "AsyncIteratorPrototype/Symbol.asyncIterator/length.js"
    );
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncIterator_name,
        "AsyncIteratorPrototype/Symbol.asyncIterator/name.js"
    );
    test262_builtin_fixture!(
        AsyncIteratorPrototype_Symbol_asyncIterator_prop_desc,
        "AsyncIteratorPrototype/Symbol.asyncIterator/prop-desc.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_extensibility,
        "GeneratorFunction/extensibility.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_has_instance,
        "GeneratorFunction/has-instance.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_instance_construct_throws,
        "GeneratorFunction/instance-construct-throws.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_instance_length,
        "GeneratorFunction/instance-length.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_instance_name,
        "GeneratorFunction/instance-name.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_instance_prototype,
        "GeneratorFunction/instance-prototype.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_invoked_as_constructor_no_arguments,
        "GeneratorFunction/invoked-as-constructor-no-arguments.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_invoked_as_function_multiple_arguments,
        "GeneratorFunction/invoked-as-function-multiple-arguments.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_invoked_as_function_no_arguments,
        "GeneratorFunction/invoked-as-function-no-arguments.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_invoked_as_function_single_argument,
        "GeneratorFunction/invoked-as-function-single-argument.js"
    );
    test262_builtin_fixture!(GeneratorFunction_length, "GeneratorFunction/length.js");
    test262_builtin_fixture!(GeneratorFunction_name, "GeneratorFunction/name.js");
    test262_builtin_fixture!(
        GeneratorFunction_prototype_constructor,
        "GeneratorFunction/prototype/constructor.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_prototype_extensibility,
        "GeneratorFunction/prototype/extensibility.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_prototype_not_callable,
        "GeneratorFunction/prototype/not-callable.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_prototype_prop_desc,
        "GeneratorFunction/prototype/prop-desc.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_prototype_prototype,
        "GeneratorFunction/prototype/prototype.js"
    );
    test262_builtin_fixture!(
        GeneratorFunction_prototype_Symbol_toStringTag,
        "GeneratorFunction/prototype/Symbol.toStringTag.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_extensibility,
        "AsyncGeneratorFunction/extensibility.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_has_instance,
        "AsyncGeneratorFunction/has-instance.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_instance_construct_throws,
        "AsyncGeneratorFunction/instance-construct-throws.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_instance_length,
        "AsyncGeneratorFunction/instance-length.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_instance_name,
        "AsyncGeneratorFunction/instance-name.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_instance_prototype,
        "AsyncGeneratorFunction/instance-prototype.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_length,
        "AsyncGeneratorFunction/length.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_name,
        "AsyncGeneratorFunction/name.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_prototype_constructor,
        "AsyncGeneratorFunction/prototype/constructor.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_prototype_extensibility,
        "AsyncGeneratorFunction/prototype/extensibility.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_prototype_not_callable,
        "AsyncGeneratorFunction/prototype/not-callable.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_prototype_prop_desc,
        "AsyncGeneratorFunction/prototype/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_prototype_prototype,
        "AsyncGeneratorFunction/prototype/prototype.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorFunction_prototype_Symbol_toStringTag,
        "AsyncGeneratorFunction/prototype/Symbol.toStringTag.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_next_length,
        "AsyncGeneratorPrototype/next/length.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_next_name,
        "AsyncGeneratorPrototype/next/name.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_next_prop_desc,
        "AsyncGeneratorPrototype/next/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_next_return_promise,
        "AsyncGeneratorPrototype/next/return-promise.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_return_length,
        "AsyncGeneratorPrototype/return/length.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_return_name,
        "AsyncGeneratorPrototype/return/name.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_return_prop_desc,
        "AsyncGeneratorPrototype/return/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_return_return_promise,
        "AsyncGeneratorPrototype/return/return-promise.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_throw_length,
        "AsyncGeneratorPrototype/throw/length.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_throw_name,
        "AsyncGeneratorPrototype/throw/name.js"
    );
    test262_builtin_fixture!(
        AsyncGeneratorPrototype_throw_prop_desc,
        "AsyncGeneratorPrototype/throw/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction_construct,
        "AsyncFunction/AsyncFunction-construct.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction_is_extensible,
        "AsyncFunction/AsyncFunction-is-extensible.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction_is_subclass,
        "AsyncFunction/AsyncFunction-is-subclass.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction_length,
        "AsyncFunction/AsyncFunction-length.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction_name,
        "AsyncFunction/AsyncFunction-name.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction_prototype,
        "AsyncFunction/AsyncFunction-prototype.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunction,
        "AsyncFunction/AsyncFunction.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunctionPrototype_is_extensible,
        "AsyncFunction/AsyncFunctionPrototype-is-extensible.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunctionPrototype_is_not_callable,
        "AsyncFunction/AsyncFunctionPrototype-is-not-callable.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_AsyncFunctionPrototype_prototype,
        "AsyncFunction/AsyncFunctionPrototype-prototype.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_instance_construct_throws,
        "AsyncFunction/instance-construct-throws.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_instance_has_name,
        "AsyncFunction/instance-has-name.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_instance_length,
        "AsyncFunction/instance-length.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_instance_prototype_property,
        "AsyncFunction/instance-prototype-property.js"
    );
    test262_builtin_fixture!(
        AsyncFunction_is_not_a_global,
        "AsyncFunction/is-not-a-global.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_consecutive_yields,
        "GeneratorPrototype/next/consecutive-yields.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_context_method_invocation,
        "GeneratorPrototype/next/context-method-invocation.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_length,
        "GeneratorPrototype/next/length.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_lone_return,
        "GeneratorPrototype/next/lone-return.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_lone_yield,
        "GeneratorPrototype/next/lone-yield.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_name,
        "GeneratorPrototype/next/name.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_no_control_flow,
        "GeneratorPrototype/next/no-control-flow.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_not_a_constructor,
        "GeneratorPrototype/next/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_property_descriptor,
        "GeneratorPrototype/next/property-descriptor.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_return_yield_expr,
        "GeneratorPrototype/next/return-yield-expr.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_this_val_not_generator,
        "GeneratorPrototype/next/this-val-not-generator.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_next_this_val_not_object,
        "GeneratorPrototype/next/this-val-not-object.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_from_state_suspended_start,
        "GeneratorPrototype/return/from-state-suspended-start.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_length,
        "GeneratorPrototype/return/length.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_name,
        "GeneratorPrototype/return/name.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_not_a_constructor,
        "GeneratorPrototype/return/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_property_descriptor,
        "GeneratorPrototype/return/property-descriptor.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_this_val_not_generator,
        "GeneratorPrototype/return/this-val-not-generator.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_this_val_not_object,
        "GeneratorPrototype/return/this-val-not-object.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_catch_before_try,
        "GeneratorPrototype/return/try-catch-before-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_catch_following_catch,
        "GeneratorPrototype/return/try-catch-following-catch.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_catch_within_catch,
        "GeneratorPrototype/return/try-catch-within-catch.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_catch_within_try,
        "GeneratorPrototype/return/try-catch-within-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_before_try,
        "GeneratorPrototype/return/try-finally-before-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_following_finally,
        "GeneratorPrototype/return/try-finally-following-finally.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_nested_try_catch_within_catch,
        "GeneratorPrototype/return/try-finally-nested-try-catch-within-catch.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_nested_try_catch_within_finally,
        "GeneratorPrototype/return/try-finally-nested-try-catch-within-finally.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_nested_try_catch_within_inner_try,
        "GeneratorPrototype/return/try-finally-nested-try-catch-within-inner-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_nested_try_catch_within_outer_try_after_nested,
        "GeneratorPrototype/return/try-finally-nested-try-catch-within-outer-try-after-nested.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_nested_try_catch_within_outer_try_before_nested,
        "GeneratorPrototype/return/try-finally-nested-try-catch-within-outer-try-before-nested.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_set_property_within_try,
        "GeneratorPrototype/return/try-finally-set-property-within-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_return_try_finally_within_try,
        "GeneratorPrototype/return/try-finally-within-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_from_state_suspended_start,
        "GeneratorPrototype/throw/from-state-suspended-start.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_length,
        "GeneratorPrototype/throw/length.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_name,
        "GeneratorPrototype/throw/name.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_not_a_constructor,
        "GeneratorPrototype/throw/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_property_descriptor,
        "GeneratorPrototype/throw/property-descriptor.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_this_val_not_generator,
        "GeneratorPrototype/throw/this-val-not-generator.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_this_val_not_object,
        "GeneratorPrototype/throw/this-val-not-object.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_catch_before_try,
        "GeneratorPrototype/throw/try-catch-before-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_catch_following_catch,
        "GeneratorPrototype/throw/try-catch-following-catch.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_catch_within_catch,
        "GeneratorPrototype/throw/try-catch-within-catch.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_catch_within_try,
        "GeneratorPrototype/throw/try-catch-within-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_finally_before_try,
        "GeneratorPrototype/throw/try-finally-before-try.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_finally_nested_try_catch_within_catch,
        "GeneratorPrototype/throw/try-finally-nested-try-catch-within-catch.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_finally_nested_try_catch_within_finally,
        "GeneratorPrototype/throw/try-finally-nested-try-catch-within-finally.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_finally_nested_try_catch_within_outer_try_after_nested,
        "GeneratorPrototype/throw/try-finally-nested-try-catch-within-outer-try-after-nested.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_finally_nested_try_catch_within_outer_try_before_nested,
        "GeneratorPrototype/throw/try-finally-nested-try-catch-within-outer-try-before-nested.js"
    );
    test262_builtin_fixture!(
        GeneratorPrototype_throw_try_finally_within_try,
        "GeneratorPrototype/throw/try-finally-within-try.js"
    );
    test262_builtin_fixture!(
        AsyncFromSyncIteratorPrototype_next_return_promise,
        "AsyncFromSyncIteratorPrototype/next/return-promise.js"
    );
    test262_builtin_fixture!(
        DisposableStack_constructor,
        "DisposableStack/constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_instance_extensible,
        "DisposableStack/instance-extensible.js"
    );
    test262_builtin_fixture!(
        DisposableStack_is_a_constructor,
        "DisposableStack/is-a-constructor.js"
    );
    test262_builtin_fixture!(DisposableStack_length, "DisposableStack/length.js");
    test262_builtin_fixture!(DisposableStack_name, "DisposableStack/name.js");
    test262_builtin_fixture!(DisposableStack_prop_desc, "DisposableStack/prop-desc.js");
    test262_builtin_fixture!(DisposableStack_proto, "DisposableStack/proto.js");
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_allows_any_value,
        "DisposableStack/prototype/adopt/allows-any-value.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_length,
        "DisposableStack/prototype/adopt/length.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_name,
        "DisposableStack/prototype/adopt/name.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_not_a_constructor,
        "DisposableStack/prototype/adopt/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_prop_desc,
        "DisposableStack/prototype/adopt/prop-desc.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_returns_value,
        "DisposableStack/prototype/adopt/returns-value.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_this_does_not_have_internal_disposablestate_throws,
        "DisposableStack/prototype/adopt/this-does-not-have-internal-disposablestate-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_this_not_object_throws,
        "DisposableStack/prototype/adopt/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_throws_if_disposed,
        "DisposableStack/prototype/adopt/throws-if-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_adopt_throws_if_onDispose_not_callable,
        "DisposableStack/prototype/adopt/throws-if-onDispose-not-callable.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_constructor,
        "DisposableStack/prototype/constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_adds_onDispose,
        "DisposableStack/prototype/defer/adds-onDispose.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_length,
        "DisposableStack/prototype/defer/length.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_name,
        "DisposableStack/prototype/defer/name.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_not_a_constructor,
        "DisposableStack/prototype/defer/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_prop_desc,
        "DisposableStack/prototype/defer/prop-desc.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_puts_onDispose_on_top_of_stack,
        "DisposableStack/prototype/defer/puts-onDispose-on-top-of-stack.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_returns_undefined,
        "DisposableStack/prototype/defer/returns-undefined.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_this_does_not_have_internal_disposablestate_throws,
        "DisposableStack/prototype/defer/this-does-not-have-internal-disposablestate-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_this_not_object_throws,
        "DisposableStack/prototype/defer/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_throws_if_disposed,
        "DisposableStack/prototype/defer/throws-if-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_defer_throws_if_onDispose_not_callable,
        "DisposableStack/prototype/defer/throws-if-onDispose-not-callable.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_does_not_reinvoke_disposers_if_already_disposed,
        "DisposableStack/prototype/dispose/does-not-reinvoke-disposers-if-already-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_does_not_throw_if_already_disposed,
        "DisposableStack/prototype/dispose/does-not-throw-if-already-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_length,
        "DisposableStack/prototype/dispose/length.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_name,
        "DisposableStack/prototype/dispose/name.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_not_a_constructor,
        "DisposableStack/prototype/dispose/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_prop_desc,
        "DisposableStack/prototype/dispose/prop-desc.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_returns_undefined,
        "DisposableStack/prototype/dispose/returns-undefined.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_sets_state_to_disposed,
        "DisposableStack/prototype/dispose/sets-state-to-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_this_not_object_throws,
        "DisposableStack/prototype/dispose/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_throws_error_as_is_if_only_one_error_during_disposal,
        "DisposableStack/prototype/dispose/throws-error-as-is-if-only-one-error-during-disposal.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_dispose_throws_suppressederror_if_multiple_errors_during_disposal,
        "DisposableStack/prototype/dispose/throws-suppressederror-if-multiple-errors-during-disposal.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_does_not_have_disposablestate_internal_slot,
        "DisposableStack/prototype/disposed/does-not-have-disposablestate-internal-slot.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_getter,
        "DisposableStack/prototype/disposed/getter.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_length,
        "DisposableStack/prototype/disposed/length.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_name,
        "DisposableStack/prototype/disposed/name.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_returns_false_when_not_disposed,
        "DisposableStack/prototype/disposed/returns-false-when-not-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_returns_true_when_disposed,
        "DisposableStack/prototype/disposed/returns-true-when-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_disposed_this_not_object_throw,
        "DisposableStack/prototype/disposed/this-not-object-throw.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_does_not_dispose_resources,
        "DisposableStack/prototype/move/does-not-dispose-resources.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_length,
        "DisposableStack/prototype/move/length.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_name,
        "DisposableStack/prototype/move/name.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_not_a_constructor,
        "DisposableStack/prototype/move/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_prop_desc,
        "DisposableStack/prototype/move/prop-desc.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_returns_new_disposablestack_that_is_still_pending,
        "DisposableStack/prototype/move/returns-new-disposablestack-that-is-still-pending.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_returns_new_disposablestack,
        "DisposableStack/prototype/move/returns-new-disposablestack.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_sets_state_to_disposed,
        "DisposableStack/prototype/move/sets-state-to-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_still_returns_new_disposablestack_when_subclassed,
        "DisposableStack/prototype/move/still-returns-new-disposablestack-when-subclassed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_this_not_object_throws,
        "DisposableStack/prototype/move/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_move_throws_if_disposed,
        "DisposableStack/prototype/move/throws-if-disposed.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_prop_desc,
        "DisposableStack/prototype/prop-desc.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_proto,
        "DisposableStack/prototype/proto.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_adds_value,
        "DisposableStack/prototype/use/adds-value.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_allows_null_value,
        "DisposableStack/prototype/use/allows-null-value.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_allows_undefined_value,
        "DisposableStack/prototype/use/allows-undefined-value.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_gets_value_Symbol_dispose_property_once,
        "DisposableStack/prototype/use/gets-value-Symbol.dispose-property-once.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_length,
        "DisposableStack/prototype/use/length.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_name,
        "DisposableStack/prototype/use/name.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_not_a_constructor,
        "DisposableStack/prototype/use/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_prop_desc,
        "DisposableStack/prototype/use/prop-desc.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_puts_value_on_top_of_stack,
        "DisposableStack/prototype/use/puts-value-on-top-of-stack.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_returns_value,
        "DisposableStack/prototype/use/returns-value.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_Symbol_dispose_getter,
        "DisposableStack/prototype/use/Symbol.dispose-getter.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_this_not_object_throws,
        "DisposableStack/prototype/use/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_throws_if_value_missing_Symbol_dispose,
        "DisposableStack/prototype/use/throws-if-value-missing-Symbol.dispose.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_throws_if_value_not_object,
        "DisposableStack/prototype/use/throws-if-value-not-object.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_throws_if_value_Symbol_dispose_property_is_null,
        "DisposableStack/prototype/use/throws-if-value-Symbol.dispose-property-is-null.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_throws_if_value_Symbol_dispose_property_is_undefined,
        "DisposableStack/prototype/use/throws-if-value-Symbol.dispose-property-is-undefined.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_use_throws_if_value_Symbol_dispose_property_not_callable,
        "DisposableStack/prototype/use/throws-if-value-Symbol.dispose-property-not-callable.js"
    );
    test262_builtin_fixture!(
        DisposableStack_prototype_from_newtarget,
        "DisposableStack/prototype-from-newtarget.js"
    );
    test262_builtin_fixture!(
        DisposableStack_undefined_newtarget_throws,
        "DisposableStack/undefined-newtarget-throws.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_constructor,
        "AsyncDisposableStack/constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_instance_extensible,
        "AsyncDisposableStack/instance-extensible.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_is_a_constructor,
        "AsyncDisposableStack/is-a-constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_length,
        "AsyncDisposableStack/length.js"
    );
    test262_builtin_fixture!(AsyncDisposableStack_name, "AsyncDisposableStack/name.js");
    test262_builtin_fixture!(
        AsyncDisposableStack_prop_desc,
        "AsyncDisposableStack/prop-desc.js"
    );
    test262_builtin_fixture!(AsyncDisposableStack_proto, "AsyncDisposableStack/proto.js");
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_allows_any_value,
        "AsyncDisposableStack/prototype/adopt/allows-any-value.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_length,
        "AsyncDisposableStack/prototype/adopt/length.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_name,
        "AsyncDisposableStack/prototype/adopt/name.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_not_a_constructor,
        "AsyncDisposableStack/prototype/adopt/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_prop_desc,
        "AsyncDisposableStack/prototype/adopt/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_returns_value,
        "AsyncDisposableStack/prototype/adopt/returns-value.js"
    );
    test262_builtin_fixture!(AsyncDisposableStack_prototype_adopt_this_does_not_have_internal_asyncdisposablestate_throws, "AsyncDisposableStack/prototype/adopt/this-does-not-have-internal-asyncdisposablestate-throws.js");
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_this_not_object_throws,
        "AsyncDisposableStack/prototype/adopt/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_throws_if_disposed,
        "AsyncDisposableStack/prototype/adopt/throws-if-disposed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_adopt_throws_if_onDisposeAsync_not_callable,
        "AsyncDisposableStack/prototype/adopt/throws-if-onDisposeAsync-not-callable.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_constructor,
        "AsyncDisposableStack/prototype/constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_length,
        "AsyncDisposableStack/prototype/defer/length.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_name,
        "AsyncDisposableStack/prototype/defer/name.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_not_a_constructor,
        "AsyncDisposableStack/prototype/defer/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_prop_desc,
        "AsyncDisposableStack/prototype/defer/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_returns_undefined,
        "AsyncDisposableStack/prototype/defer/returns-undefined.js"
    );
    test262_builtin_fixture!(AsyncDisposableStack_prototype_defer_this_does_not_have_internal_asyncdisposablestate_throws, "AsyncDisposableStack/prototype/defer/this-does-not-have-internal-asyncdisposablestate-throws.js");
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_this_not_object_throws,
        "AsyncDisposableStack/prototype/defer/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_throws_if_disposed,
        "AsyncDisposableStack/prototype/defer/throws-if-disposed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_defer_throws_if_onDisposeAsync_not_callable,
        "AsyncDisposableStack/prototype/defer/throws-if-onDisposeAsync-not-callable.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposeAsync_length,
        "AsyncDisposableStack/prototype/disposeAsync/length.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposeAsync_name,
        "AsyncDisposableStack/prototype/disposeAsync/name.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposeAsync_not_a_constructor,
        "AsyncDisposableStack/prototype/disposeAsync/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposeAsync_prop_desc,
        "AsyncDisposableStack/prototype/disposeAsync/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_does_not_have_asyncdisposablestate_internal_slot,
        "AsyncDisposableStack/prototype/disposed/does-not-have-asyncdisposablestate-internal-slot.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_getter,
        "AsyncDisposableStack/prototype/disposed/getter.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_length,
        "AsyncDisposableStack/prototype/disposed/length.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_name,
        "AsyncDisposableStack/prototype/disposed/name.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_returns_false_when_not_disposed,
        "AsyncDisposableStack/prototype/disposed/returns-false-when-not-disposed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_returns_true_when_disposed,
        "AsyncDisposableStack/prototype/disposed/returns-true-when-disposed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_disposed_this_not_object_throw,
        "AsyncDisposableStack/prototype/disposed/this-not-object-throw.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_does_not_dispose_resources,
        "AsyncDisposableStack/prototype/move/does-not-dispose-resources.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_length,
        "AsyncDisposableStack/prototype/move/length.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_name,
        "AsyncDisposableStack/prototype/move/name.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_not_a_constructor,
        "AsyncDisposableStack/prototype/move/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_prop_desc,
        "AsyncDisposableStack/prototype/move/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_returns_new_asyncdisposablestack_that_is_still_pending,
        "AsyncDisposableStack/prototype/move/returns-new-asyncdisposablestack-that-is-still-pending.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_returns_new_asyncdisposablestack,
        "AsyncDisposableStack/prototype/move/returns-new-asyncdisposablestack.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_sets_state_to_disposed,
        "AsyncDisposableStack/prototype/move/sets-state-to-disposed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_still_returns_new_asyncdisposablestack_when_subclassed,
        "AsyncDisposableStack/prototype/move/still-returns-new-asyncdisposablestack-when-subclassed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_this_not_object_throws,
        "AsyncDisposableStack/prototype/move/this-not-object-throws.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_move_throws_if_disposed,
        "AsyncDisposableStack/prototype/move/throws-if-disposed.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_prop_desc,
        "AsyncDisposableStack/prototype/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_proto,
        "AsyncDisposableStack/prototype/proto.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_length,
        "AsyncDisposableStack/prototype/use/length.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_name,
        "AsyncDisposableStack/prototype/use/name.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_not_a_constructor,
        "AsyncDisposableStack/prototype/use/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_prop_desc,
        "AsyncDisposableStack/prototype/use/prop-desc.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_this_not_object_throws,
        "AsyncDisposableStack/prototype/use/this-not-object-throws.js"
    );
    test262_builtin_fixture!(AsyncDisposableStack_prototype_use_throws_if_value_missing_Symbol_asyncDispose_and_Symbol_dispose, "AsyncDisposableStack/prototype/use/throws-if-value-missing-Symbol.asyncDispose-and-Symbol.dispose.js");
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_throws_if_value_not_object,
        "AsyncDisposableStack/prototype/use/throws-if-value-not-object.js"
    );
    test262_builtin_fixture!(AsyncDisposableStack_prototype_use_throws_if_value_Symbol_asyncDispose_property_is_null_or_undefined, "AsyncDisposableStack/prototype/use/throws-if-value-Symbol.asyncDispose-property-is-null-or-undefined.js");
    test262_builtin_fixture!(AsyncDisposableStack_prototype_use_throws_if_value_Symbol_asyncDispose_property_not_callable, "AsyncDisposableStack/prototype/use/throws-if-value-Symbol.asyncDispose-property-not-callable.js");
    test262_builtin_fixture!(AsyncDisposableStack_prototype_use_throws_if_value_Symbol_dispose_property_is_null_or_undefined, "AsyncDisposableStack/prototype/use/throws-if-value-Symbol.dispose-property-is-null-or-undefined.js");
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_use_throws_if_value_Symbol_dispose_property_not_callable,
        "AsyncDisposableStack/prototype/use/throws-if-value-Symbol.dispose-property-not-callable.js"
    );
    test262_builtin_fixture!(
        AsyncDisposableStack_prototype_from_newtarget,
        "AsyncDisposableStack/prototype-from-newtarget.js"
    );
    test262_builtin_fixture!(
    ...
    test262_builtin_fixture!(
        Promise_all_invoke_resolve_get_once_no_calls,
        "Promise/all/invoke-resolve-get-once-no-calls.js"
    );
    test262_builtin_fixture!(
        Promise_all_invoke_then_error_close,
        "Promise/all/invoke-then-error-close.js"
    );
    test262_builtin_fixture!(
        Promise_all_invoke_then_get_error_close,
        "Promise/all/invoke-then-get-error-close.js"
    );
    test262_builtin_fixture!(Promise_all_invoke_then, "Promise/all/invoke-then.js");
    test262_builtin_fixture!(Promise_all_length, "Promise/all/length.js");
    test262_builtin_fixture!(Promise_all_name, "Promise/all/name.js");
    test262_builtin_fixture!(
        Promise_all_not_a_constructor,
        "Promise/all/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_all_prop_desc, "Promise/all/prop-desc.js");
    test262_builtin_fixture!(
        Promise_all_S25_4_4_1_A1_1_T1,
        "Promise/all/S25.4.4.1_A1.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_all_S25_4_4_1_A2_1_T1,
        "Promise/all/S25.4.4.1_A2.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_all_S25_4_4_1_A4_1_T1,
        "Promise/all/S25.4.4.1_A4.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_allKeyed_ctx_non_ctor,
        "Promise/allKeyed/ctx-non-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_allKeyed_not_a_constructor,
        "Promise/allKeyed/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_ctx_non_ctor,
        "Promise/allSettled/ctx-non-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_ctx_non_object,
        "Promise/allSettled/ctx-non-object.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_invoke_resolve_get_once_no_calls,
        "Promise/allSettled/invoke-resolve-get-once-no-calls.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_invoke_then_error_close,
        "Promise/allSettled/invoke-then-error-close.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_invoke_then_get_error_close,
        "Promise/allSettled/invoke-then-get-error-close.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_invoke_then,
        "Promise/allSettled/invoke-then.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_is_function,
        "Promise/allSettled/is-function.js"
    );
    test262_builtin_fixture!(Promise_allSettled_length, "Promise/allSettled/length.js");
    test262_builtin_fixture!(Promise_allSettled_name, "Promise/allSettled/name.js");
    test262_builtin_fixture!(
        Promise_allSettled_not_a_constructor,
        "Promise/allSettled/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_prop_desc,
        "Promise/allSettled/prop-desc.js"
    );
    test262_builtin_fixture!(
        Promise_allSettled_returns_promise,
        "Promise/allSettled/returns-promise.js"
    );
    test262_builtin_fixture!(
        Promise_allSettledKeyed_ctx_non_ctor,
        "Promise/allSettledKeyed/ctx-non-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_allSettledKeyed_not_a_constructor,
        "Promise/allSettledKeyed/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_any_ctx_non_ctor, "Promise/any/ctx-non-ctor.js");
    test262_builtin_fixture!(Promise_any_ctx_non_object, "Promise/any/ctx-non-object.js");
    test262_builtin_fixture!(Promise_any_is_function, "Promise/any/is-function.js");
    test262_builtin_fixture!(Promise_any_length, "Promise/any/length.js");
    test262_builtin_fixture!(Promise_any_name, "Promise/any/name.js");
    test262_builtin_fixture!(
        Promise_any_not_a_constructor,
        "Promise/any/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_any_prop_desc, "Promise/any/prop-desc.js");
    test262_builtin_fixture!(
        Promise_any_returns_promise,
        "Promise/any/returns-promise.js"
    );
    test262_builtin_fixture!(Promise_constructor, "Promise/constructor.js");
    test262_builtin_fixture!(Promise_exec_args, "Promise/exec-args.js");
    test262_builtin_fixture!(
        Promise_executor_call_context_sloppy,
        "Promise/executor-call-context-sloppy.js"
    );
    test262_builtin_fixture!(
        Promise_executor_call_context_strict,
        "Promise/executor-call-context-strict.js"
    );
    test262_builtin_fixture!(
        Promise_executor_not_callable,
        "Promise/executor-not-callable.js"
    );
    test262_builtin_fixture!(Promise_is_a_constructor, "Promise/is-a-constructor.js");
    test262_builtin_fixture!(Promise_length, "Promise/length.js");
    test262_builtin_fixture!(Promise_name, "Promise/name.js");
    test262_builtin_fixture!(Promise_promise, "Promise/promise.js");
    test262_builtin_fixture!(Promise_property_order, "Promise/property-order.js");
    test262_builtin_fixture!(
        Promise_prototype_catch_length,
        "Promise/prototype/catch/length.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_catch_name,
        "Promise/prototype/catch/name.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_catch_not_a_constructor,
        "Promise/prototype/catch/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_catch_prop_desc,
        "Promise/prototype/catch/prop-desc.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_catch_this_value_non_object,
        "Promise/prototype/catch/this-value-non-object.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_catch_this_value_then_not_callable,
        "Promise/prototype/catch/this-value-then-not-callable.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_is_a_method,
        "Promise/prototype/finally/is-a-method.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_length,
        "Promise/prototype/finally/length.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_name,
        "Promise/prototype/finally/name.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_not_a_constructor,
        "Promise/prototype/finally/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_prop_desc,
        "Promise/prototype/finally/prop-desc.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_species_constructor_throws,
        "Promise/prototype/finally/species-constructor-throws.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_subclass_species_constructor_reject_count,
        "Promise/prototype/finally/subclass-species-constructor-reject-count.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_subclass_species_constructor_resolve_count,
        "Promise/prototype/finally/subclass-species-constructor-resolve-count.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_this_value_non_object,
        "Promise/prototype/finally/this-value-non-object.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_finally_this_value_then_not_callable,
        "Promise/prototype/finally/this-value-then-not-callable.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_no_promise_state,
        "Promise/prototype/no-promise-state.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_prop_desc,
        "Promise/prototype/prop-desc.js"
    );
    test262_builtin_fixture!(Promise_prototype_proto, "Promise/prototype/proto.js");
    test262_builtin_fixture!(
        Promise_prototype_S25_4_4_2_A1_1_T1,
        "Promise/prototype/S25.4.4.2_A1.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_S25_4_5_A3_1_T1,
        "Promise/prototype/S25.4.5_A3.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_capability_executor_not_callable,
        "Promise/prototype/then/capability-executor-not-callable.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_context_check_on_entry,
        "Promise/prototype/then/context-check-on-entry.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_ctor_poisoned,
        "Promise/prototype/then/ctor-poisoned.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_ctor_undef,
        "Promise/prototype/then/ctor-undef.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_length,
        "Promise/prototype/then/length.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_name,
        "Promise/prototype/then/name.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_not_a_constructor,
        "Promise/prototype/then/not-a-constructor.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_prop_desc,
        "Promise/prototype/then/prop-desc.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_S25_4_5_3_A2_1_T1,
        "Promise/prototype/then/S25.4.5.3_A2.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_prototype_then_S25_4_5_3_A2_1_T2,
        "Promise/prototype/then/S25.4.5.3_A2.1_T2.js"
    );
    test262_builtin_fixture!(Promise_race_ctx_non_ctor, "Promise/race/ctx-non-ctor.js");
    test262_builtin_fixture!(
        Promise_race_ctx_non_object,
        "Promise/race/ctx-non-object.js"
    );
    test262_builtin_fixture!(
        Promise_race_invoke_resolve_get_once_no_calls,
        "Promise/race/invoke-resolve-get-once-no-calls.js"
    );
    test262_builtin_fixture!(
        Promise_race_invoke_then_error_close,
        "Promise/race/invoke-then-error-close.js"
    );
    test262_builtin_fixture!(
        Promise_race_invoke_then_get_error_close,
        "Promise/race/invoke-then-get-error-close.js"
    );
    test262_builtin_fixture!(Promise_race_invoke_then, "Promise/race/invoke-then.js");
    test262_builtin_fixture!(Promise_race_length, "Promise/race/length.js");
    test262_builtin_fixture!(Promise_race_name, "Promise/race/name.js");
    test262_builtin_fixture!(
        Promise_race_not_a_constructor,
        "Promise/race/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_race_prop_desc, "Promise/race/prop-desc.js");
    test262_builtin_fixture!(
        Promise_race_S25_4_4_3_A1_1_T1,
        "Promise/race/S25.4.4.3_A1.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_race_S25_4_4_3_A2_1_T1,
        "Promise/race/S25.4.4.3_A2.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_race_S25_4_4_3_A3_1_T1,
        "Promise/race/S25.4.4.3_A3.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_race_S25_4_4_3_A3_1_T2,
        "Promise/race/S25.4.4.3_A3.1_T2.js"
    );
    test262_builtin_fixture!(
        Promise_reject_ctx_non_ctor,
        "Promise/reject/ctx-non-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_reject_ctx_non_object,
        "Promise/reject/ctx-non-object.js"
    );
    test262_builtin_fixture!(Promise_reject_length, "Promise/reject/length.js");
    test262_builtin_fixture!(Promise_reject_name, "Promise/reject/name.js");
    test262_builtin_fixture!(
        Promise_reject_not_a_constructor,
        "Promise/reject/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_reject_prop_desc, "Promise/reject/prop-desc.js");
    test262_builtin_fixture!(
        Promise_reject_S25_4_4_4_A1_1_T1,
        "Promise/reject/S25.4.4.4_A1.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_reject_S25_4_4_4_A3_1_T1,
        "Promise/reject/S25.4.4.4_A3.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_reject_function_extensible,
        "Promise/reject-function-extensible.js"
    );
    test262_builtin_fixture!(
        Promise_reject_function_length,
        "Promise/reject-function-length.js"
    );
    test262_builtin_fixture!(
        Promise_reject_function_nonconstructor,
        "Promise/reject-function-nonconstructor.js"
    );
    test262_builtin_fixture!(
        Promise_reject_function_property_order,
        "Promise/reject-function-property-order.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_arg_uniq_ctor,
        "Promise/resolve/arg-uniq-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_context_non_object_with_promise,
        "Promise/resolve/context-non-object-with-promise.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_ctx_non_ctor,
        "Promise/resolve/ctx-non-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_ctx_non_object,
        "Promise/resolve/ctx-non-object.js"
    );
    test262_builtin_fixture!(Promise_resolve_length, "Promise/resolve/length.js");
    test262_builtin_fixture!(Promise_resolve_name, "Promise/resolve/name.js");
    test262_builtin_fixture!(
        Promise_resolve_not_a_constructor,
        "Promise/resolve/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_resolve_prop_desc, "Promise/resolve/prop-desc.js");
    test262_builtin_fixture!(
        Promise_resolve_resolve_prms_cstm_then,
        "Promise/resolve/resolve-prms-cstm-then.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_S25_4_4_5_A1_1_T1,
        "Promise/resolve/S25.4.4.5_A1.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_S25_4_4_5_A2_1_T1,
        "Promise/resolve/S25.4.4.5_A2.1_T1.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_function_extensible,
        "Promise/resolve-function-extensible.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_function_length,
        "Promise/resolve-function-length.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_function_nonconstructor,
        "Promise/resolve-function-nonconstructor.js"
    );
    test262_builtin_fixture!(
        Promise_resolve_function_property_order,
        "Promise/resolve-function-property-order.js"
    );
    test262_builtin_fixture!(Promise_try_ctx_non_ctor, "Promise/try/ctx-non-ctor.js");
    test262_builtin_fixture!(Promise_try_ctx_non_object, "Promise/try/ctx-non-object.js");
    test262_builtin_fixture!(Promise_try_length, "Promise/try/length.js");
    test262_builtin_fixture!(Promise_try_name, "Promise/try/name.js");
    test262_builtin_fixture!(
        Promise_try_not_a_constructor,
        "Promise/try/not-a-constructor.js"
    );
    test262_builtin_fixture!(Promise_try_promise, "Promise/try/promise.js");
    test262_builtin_fixture!(Promise_try_prop_desc, "Promise/try/prop-desc.js");
    test262_builtin_fixture!(
        Promise_undefined_newtarget,
        "Promise/undefined-newtarget.js"
    );
    test262_builtin_fixture!(
        Promise_withResolvers_ctx_non_ctor,
        "Promise/withResolvers/ctx-non-ctor.js"
    );
    test262_builtin_fixture!(
        Promise_withResolvers_ctx_non_object,
        "Promise/withResolvers/ctx-non-object.js"
    );
    test262_builtin_fixture!(
        Promise_withResolvers_promise,
        "Promise/withResolvers/promise.js"
    );
    test262_builtin_fixture!(
        Promise_withResolvers_result,
        "Promise/withResolvers/result.js"
    );
