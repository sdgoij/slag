...
4. 3.1 (L4 arena) is CLOSED by its counting probe (2026-09-04): the arena
   ...
   methods no probe has shown hot. 0.1 (the JIT Float16Array/typed-array
   miscompile) stays owned by the Linux debug agent in parallel.
